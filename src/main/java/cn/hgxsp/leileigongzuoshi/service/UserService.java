...
import cn.hgxsp.leileigongzuoshi.Utils.MD5Utils;
import cn.hgxsp.leileigongzuoshi.Utils.UpdataObjectUtil;
import cn.hgxsp.leileigongzuoshi.Utils.idworker.Sid;
...
public class UserService {
    ...
    */
    public User findUserByName(String userName){
        ...
        Example<User > findone  = Example.of(user);

        Optional<User> result = userDao.findOne(findone);
